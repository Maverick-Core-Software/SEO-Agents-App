...
def build_facebook_crew(
    ...
    fb_task = Task(
        description=(
            ...
            "- SHOW THE WORK, NOT THE FACE: focus on tools, panels, equipment — AI video models cannot render hands. "
            "Describe as TOOL-ONLY POV (the camera IS the person). Never mention hands or bodies.\n"
            "- Use the five-part formula: [Cinematography] + [Subject] + [Action] + [Context] + [Style]\n"
            "- Example: 'Static shot, tool-only POV of a circuit breaker snapping into place "
